...
function App() {
	...
	return (
		<div className="flex w-screen h-screen justify-center items-center transition-all">
			{!isAccepted ? (
				...
				<img
					...
					src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdDB5Y3E0bTBpdDF2eGNraTMwcTZ3c3B5NGJxYnpyeGVhZmgwODZjciZlcD12MV9naWZzX3NlYXJjaCZjdD1n/5dUllWbKVlaqmMTvHb/giphy.gif"
					alt="smug gif"
				/>
			)}
		</div>
